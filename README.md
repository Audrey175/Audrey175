<h1 align="center">Hi <img src="https://user-images.githubusercontent.com/18350557/176309783-0785949b-9127-417c-8b55-ab5a4333674e.gif" width="30px" /> I'm Vo Nguyen Bao Ngoc (Audrey)</h1>
<h3 align="center">Data Engineer | Data Analyst | Fintech & ML Enthusiast</h3>

<p align="center">
  <img src="https://github-readme-streak-stats.herokuapp.com?user=Audrey175&theme=react&hide_border=true&border_radius=4.4&mode=weekly" alt="GitHub Streak" />
</p>
...
- 🎓 Completing a **Bachelor of Information Technology** at RMIT Vietnam
- ☁️ **AWS Cloud Foundations** certified, with hands-on experience in real AWS lakehouse environments (IAM, Terraform, Airflow)
- 🧠 Exploring the intersection of **data engineering, machine learning, and fintech**
- 🌍 Based in Vietnam
- ✉️ Reach me at [vonguyenabaongoc0504@gmail.com](mailto:vonguyenabaongoc0504@gmail.com)

---

### 📌 Featured Projects

- **InsightX** — FastAPI + React app with U-Net/Grad-CAM for medical image analysis
- **Project Atlas** — Unified retail data lakehouse on AWS (IAM, Terraform, Airflow)
- **Company Health Dashboard** — Multi-page executive reporting suite for an e-wallet product
- **Hippocampus Segmentation** — 3D U-Net on ADNI MRI data
- **Product Intelligence Dashboard** — Demand forecasting with Python, Streamlit, and Prophet
...
Feel free to reach out about data engineering, fintech analytics, or ML projects!
